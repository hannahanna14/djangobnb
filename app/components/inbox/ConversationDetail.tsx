        ...
        <>
            <div className="max-h-[400px] overflow-auto flex flex-col space-y-4">
                <div className="w-[80%]py-4 px-6 rounded-xl bg-gray-200">
                    <p className="font-bold text-gray-500">Alice</p>
                ...
                <div className="w-[80%]py-4 ml-[20%] px-6 rounded-xl bg-blue-200">
                    <p className="font-bold text-gray-500">Jhohanna Rose Apus</p>
                    <p className="text-gray-500">Yeah, its been a while! How have you been?</p>
                </div>
            </div>
